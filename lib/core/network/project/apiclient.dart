...
class Apiclient {
  ...
  Apiclient(){
    ...
    project = [
      Project(01,  'NguyenVanA' , 'loptruong' ,Status.completed , 01, TimeStamp(  DateTime.now(),DateTime.now(),DateTime.now(),DateTime.now())),
      Project(02,  'NguyenVanB' , 'loppho' ,Status.inProgress , 02, TimeStamp(  DateTime.now(),DateTime.now(),DateTime.now(),DateTime.now())),
      Project(03,  'NguyenVanC' , 'sinhvien' ,Status.pending , 03, TimeStamp(  DateTime.now(),DateTime.now(),DateTime.now(),DateTime.now())),
    ];
  }
