...
class StageFormDialogv2 extends StatefulWidget {
  final Stage? editingStage;
  final int projectId;

  const StageFormDialogv2({
    super.key,
    this.editingStage,
  ...
  @override
  State<StageFormDialogv2> createState() => _StageFormDialogState();
}

class _StageFormDialogState extends State<StageFormDialogv2> {
  ...
  @override
  void didUpdateWidget(covariant StageFormDialogv2 oldWidget) {
