...
class ProjectRepositoryIpl extends ProjectRepository{
  ...
  Future<void> createProject(Project project) {
    final data = ProjectModel(project.id, project.name, project.description, project.status, project.createdBy, project.timestamp);
    return this.remotedatasource.createProject(data);
  }

  @override
  Future<void> deleteProject(int id) {
    return this.remotedatasource.deleteProject(id as String);
  }
  ...
  Future<void> updateProject(Project  project) {
    final data = ProjectModel(project.id, project.name, project.description, project.status, project.createdBy, project.timestamp);
    return this.remotedatasource.updateProject(data);
  }
